...
const actions = module.exports = {
	...
	*/
	...
	createNewlyLinkedPassages(store, storyId, passageId, oldText) {
		...
		/*
		 * See whether we can get text inside a passage
		 */
		console.log("===" + passage.name +", "+passage.text);
		/* Determine how many passages we'll need to create. */

		//which parse new links
		const oldLinks = linkParser(oldText, true);
		//passage.text = passage.text.concat("[[World]]");
		/*
		 * update all new links according to passage changes.
		 */
