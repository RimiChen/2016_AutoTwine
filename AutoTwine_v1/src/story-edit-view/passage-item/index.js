...
module.exports = Vue.extend({
	...
	methods: {
		...
		/*
		 * Edit passage in here?
		 */
		edit() {
			var oldText = this.passage.text;
			
			//alert(oldText)
			/*
			 * testing the context type.
			 */
...
/*			
			var text = "[[World]]";
			oldText = oldText.concat("	",text);

			this.passage.text = oldText;
			if(typeof (oldText)==='string'){
				console.log(oldText+" is a String");
			}
			else{
				console.log(" might be an Object");
			}
*/			
			new PassageEditor({
				data: {
			...
			/*
			 * Get story passage content from here.
			 */
			//alert(oldText);
		},
